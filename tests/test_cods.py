...
class TestCods():
    ...
    def configuration(self):
        ...
        Locations.set_validlocations([{'name': 'afg', 'title': 'Afghanistan'}, {'name': 'phl', 'title': 'Philippines'}])
        Country.countriesdata(use_live=False)
        Vocabulary._tags_dict = True
        Vocabulary._approved_vocabulary = {'tags': [{'name': 'common operational dataset - cod'}, {'name': 'administrative divisions'}, {'name': 'geodata'}, {'name': 'gazetteer'}], 'id': '4e61d464-4943-4e97-973a-84673c1aaa87', 'name': 'approved'}
    ...
    def test_generate_dataset(self, cod, configuration):
        ...
        assert dataset == {'name': 'philippines-subnational-administrative-boundaries', 'title': 'Philippines - Subnational Administrative Boundaries',
                           ...
                           'methodology': 'Census', 'methodology_other': '', 'license_id': 'Creative Commons Attribution for Intergovernmental Organisations',
                           'license_other': '',
                           ...
                           'tags': [{'name': 'administrative divisions', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}, {'name': 'common operational dataset - cod', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}, {'name': 'gazetteer', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}],
                           'dataset_date': '[2020-05-29T00:00:00 TO 2021-05-29T00:00:00]'}
        resources = dataset.get_resources()
        assert len(resources) == alljson[0]['Total']
        assert resources == [{'name': 'Philippines - Subnational Administrative Boundaries', 'description': 'Philippines - Subnational Administrative Boundaries', 'url': 'https://data.humdata.org/dataset/caf116df-f984-4deb-85ca-41b349d3f313/resource/80e52e31-d06c-47ab-9bfa-cbb57dc17a1e/download/phl_adminboundaries_tabulardata.xlsx', 'format': 'xlsx', 'daterange_for_data': '[2020-05-29T00:00:00 TO 2021-05-29T00:00:00]', 'grouping': 'Latest', 'resource_type': 'api', 'url_type': 'api'},
                             {'name': 'Philippines - Subnational Administrative Boundaries', 'description': 'Philippines - Subnational Administrative Boundaries', 'url': 'https://data.humdata.org/dataset/caf116df-f984-4deb-85ca-41b349d3f313/resource/12457689-6a86-4474-8032-5ca9464d38a8/download/phl_adm_psa_namria_20200529_shp.zip', 'format': 'shp', 'daterange_for_data': '[2020-05-29T00:00:00 TO 2021-05-29T00:00:00]', 'grouping': 'Latest', 'resource_type': 'api', 'url_type': 'api'},
                             {'name': 'Philippines - Subnational Administrative Boundaries', 'description': 'Philippines - Subnational Administrative Boundaries', 'url': 'https://data.humdata.org/dataset/caf116df-f984-4deb-85ca-41b349d3f313/resource/82cda4bf-19f1-47bf-9469-f8bb8e5446d3/download/phl_adm_psa_namria_20200529_emf.zip', 'format': 'emf', 'daterange_for_data': '[2020-05-29T00:00:00 TO 2021-05-29T00:00:00]', 'grouping': 'Latest', 'resource_type': 'api', 'url_type': 'api'},
        ...
        assert is_valid_uuid(batch) is True
        assert dataset == {'name': 'afghanistan-subnational-administrative-boundaries', 'title': 'Afghanistan - Subnational Administrative Boundaries',
                           ...
                           'methodology': 'Other', 'methodology_other': 'ITOS processing', 'license_id': '', 'license_other': '',
                           'caveats': 'In-country humanitarian responders', 'data_update_frequency': '365', 'cod_level': 'cod-enhanced',
                           'maintainer': '196196be-6037-4488-8b71-d786adf4c081', 'owner_org': '10e168ce-5b51-49ac-8616-a142d48618e5',
                           'subnational': '1', 'groups': [{'name': 'afg'}],
                           'tags': [{'name': 'administrative divisions', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}, {'name': 'common operational dataset - cod', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}, {'name': 'gazetteer', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}, {'name': 'geodata', 'vocabulary_id': '4e61d464-4943-4e97-973a-84673c1aaa87'}],
                           'dataset_date': '[2019-10-22T00:00:00 TO 2019-10-22T23:59:59]',
                           'is_requestdata_type': True, 'file_types': 'shp,geodatabase', 'field_names': 'Afghanistan administrative level 0-2 and UNAMA region boundary polygons,lines,and points'}
        resources = dataset.get_resources()
